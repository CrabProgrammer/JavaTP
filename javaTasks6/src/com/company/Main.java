...
public class Main {
    public static void main(String[] args) {
        ...
        int number51 = Integer.parseInt(scanner.nextLine());
        System.out.println(bell(number51));
        ...
        if (parts.length == 1)
            System.out.println(stripUrlParams(url));
        else
            System.out.println(stripUrlParams(parts[0], parts[1].split(" ")));

        // task 55
        System.out.println("Enter header:");
        String header = scanner.nextLine();
        System.out.println(getHashTags(header));
        // task 56
        System.out.println("Enter number:");
        int number56 = Integer.parseInt(scanner.nextLine());
        System.out.println(ulam(number56));


        // task 57
        System.out.println("Enter string:");
        String str57 = scanner.nextLine();
        System.out.println(longestNonrepeatSubstring(str57));


        // task 58
        System.out.println("Enter arabian:");
        int arabian = Integer.parseInt(scanner.nextLine());
        System.out.println(convertToRoman(arabian));

        // task 59
        System.out.println("Enter math function:");
        String func = scanner.nextLine();
        System.out.println(formula(func));

        // task 60
        System.out.println("Enter string:");
        int pal = Integer.parseInt(scanner.nextLine());
        System.out.println(palindromeDescendant(pal));
    }
